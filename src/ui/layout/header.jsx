        ...
        <div className="pt-3 pb-8 lg:pb-16 px-5 md:px-3 md:pt-4 flex max-w-6xl mx-auto">
          <div className="w-full">
            <div className="header_top lg:flex justify-between items-center">
              ...
              <div className="mr-0 lg:mr-0 flex items-center justify-end mt-6 lg:mt-0 w-3/12">
                <div className="w-full lg:w-auto">
                  <button
                    onClick={() => handleLogin()}
                    className="text-white h-[42px] bg-transparent font-medium text-xs lg:text-base rounded-md px-2.5 py-1 lg:px-5 lg:py-2 hover:text-[#6f41fe] mr-2"
                  >
                    Log In
                  </button>
                  <button
                    onClick={handleSignup}
                    className="text-white h-[42px] bg-transparent font-medium text-xs lg:text-base rounded-md px-2.5 py-1 lg:px-5 lg:py-2 hover:bg-[#333333] hover:text-white get_started_banner"
                  >
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center">
              <div className="w-full py-6">
                <h1 className="text-[50px] leading-[60px] text-white font-semibold pb-5 banner_title_text w-8/12 mx-auto font-SatoshiBold">
                  The Future of <span>Customer Research </span>
                  Is Here
                </h1>
                <div className="w-9/12 mx-auto">
                  <p className="text-base text-white font-normal pb-8 pr-0 font-SatoshiMedium">
                    Imagine being able to talk to your customers before you
                    launch anything. Not through surveys. Not through guesswork.
                    But through realistic, data-driven AI personas that respond
                    like real buyers — because they’re built from real customer
                    data.
                  </p>
                </div>
                <button
                  onClick={handleSignup}
                  className="text-white bg-transparent font-medium text-sm lg:text-sm rounded-md px-2.5 py-1 lg:px-10 lg:py-3.5 hover:bg-[#333333] hover:text-white get_started_banner font-SatoshiBlack"
                >
                  <div className="flex items-center text-white">
                    BUILD YOUR OWN AI CHARATER
                  </div>
                </button>
              </div>
            </div>
            <div className="grid grid-cols-4 gap-4 mt-10">
              <div className="border border-[#583a87] rounded-xl overflow-hidden relative">
                ...
                <div className="bg-[#472386] text-center w-full h-[98px] absolute left-0 bottom-0">
